Я сделал эту домашнюю работу отдельно, потому что она пересекается с предыдущей и следующей.
